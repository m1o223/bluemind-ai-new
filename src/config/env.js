...
const envSchema = z.object({
  ...
  CORS_ORIGIN: z.string().trim().default("https://your-vercel-frontend-domain.vercel.app"),
  ...
  AUTH_OAUTH_STATE_COOKIE_NAME: z.string().trim().default("bluemind_oauth_state"),
  ...
  FRONTEND_URL: z.string().trim().default("https://your-vercel-frontend-domain.vercel.app"),
  BACKEND_PUBLIC_URL: z.string().trim().default("https://your-render-backend-domain.onrender.com"),
