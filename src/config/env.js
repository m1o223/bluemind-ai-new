...
const envSchema = z.object({
  ...
  CORS_ORIGIN: z.string().trim().default("http://localhost:3000,http://localhost:5173,http://127.0.0.1:3000,http://127.0.0.1:5173"),
  ...
  FRONTEND_URL: z.string().trim().default("http://127.0.0.1:5173"),
  BACKEND_PUBLIC_URL: z.string().trim().default("http://127.0.0.1:5000"),
